package com.winter.market.core.service.paypal;

import com.paypal.orders.*;
import com.winter.market.core.entities.Order;
import com.winter.market.core.exeptions.NotFoundException;
...
public class PayPalService {
    ...
    public OrderRequest createOrderRequest(Long orderId) {
        Order order = orderService.findById(orderId).orElseThrow(() -> new NotFoundException("Заказ не найден"));
        ...
        PurchaseUnitRequest purchaseUnitRequest = new PurchaseUnitRequest()
                ...
                .items(order.getItems().stream()
                        .map(orderItem -> new Item()
                                ...
                                .quantity(String.valueOf(orderItem.getQty())))
